...
def gaussian_noise(x, severity=1):
    c = [.08, .12, 0.18, 0.26, 0.38, .46, .58, 0.66, 0.78, 0.86][severity - 1]
...
def shot_noise(x, severity=1):
    c = [60, 25, 12, 5, 3, 2.5, 2, 1.5, 1, 0.5][severity - 1]
...
def impulse_noise(x, severity=1):
    c = [.03, .06, .09, 0.17, 0.27, .37, .47, .57, 0.67, 0.77][severity - 1]
...
def speckle_noise(x, severity=1):
    c = [.15, .2, 0.35, 0.45, 0.6, .7, .8, .9, 1, 1.2][severity - 1]
...
def gaussian_blur(x, severity=1):
    c = [1, 2, 3, 4, 6, 8, 9, 10, 12, 14][severity - 1]
...
def glass_blur(x, severity=1):
    ...
    c = [(0.7, 1, 2), (0.9, 2, 1), (1, 2, 3), (1.1, 3, 2), (1.5, 4, 2), (1.8, 4, 3), (2, 4, 2), (2.2, 5, 4), (2.4, 5, 3), (2.8, 6, 3)][severity - 1]
...
def defocus_blur(x, severity=1):
    c = [(3, 0.1), (4, 0.5), (6, 0.5), (8, 0.5), (10, 0.5), (12, 0.8), (14, 0.8), (16, 0.8), (18, 0.8), (20, 1)][severity - 1]
...
def motion_blur(x, severity=1):
    c = [(10, 3), (15, 5), (15, 8), (15, 12), (20, 15), (25, 18), (25, 20), (30, 22), (35, 24), (40, 25)][severity - 1]
...
def zoom_blur(x, severity=1):
    c = [np.arange(1, 1.11, 0.01),
         ...
         np.arange(1, 1.41, 0.03),
         np.arange(1, 1.46, 0.03),
         np.arange(1, 1.51, 0.04),
         np.arange(1, 1.56, 0.04)][severity - 1]
...
def fog(x, severity=1):
    c = [(1.5, 2), (2, 2), (2.5, 1.7), (2.5, 1.5), (3, 1.4), (3.5, 1.2), (4, 1), (4.5, 0.8), (5, 0.6), (5.5, 0.4)][severity - 1]
...
def snow(x, severity=1):
    c = [(0.1, 0.3, 3, 0.5, 10, 4, 0.8),
         ...
         (0.65, 0.3, 4, 0.8, 12, 12, 0.5),
         (0.65, 0.3, 3, 0.8, 14, 14, 0.45),
         (0.7, 0.3, 5, 0.95, 14, 15, 0.4),
         (0.75, 0.3, 5.5, 0.95, 16, 8, 0.35),
         (0.8, 0.3, 3.5, 0.95, 16, 17, 0.3)][severity - 1]
...
def spatter(x, severity=1):
    c = [(0.65, 0.3, 4, 0.69, 0.6, 0),
         ...
         (0.68, 0.4, 1, 0.64, 1.6, 0),
         (0.68, 0.4, 1, 0.63, 2, 0),
         (0.68, 0.4, 1, 0.62, 2.5, 0),
         (0.69, 0.4, 1, 0.61, 3, 1),
         (0.69, 0.5, 1, 0.6, 3.5, 1)][severity - 1]
    x = np.array(x, dtype=np.float32) / 255.
...
def contrast(x, severity=1):
    c = [0.4, .3, .2, .1, .05, 0.04, .03, .02, .01, .005][severity - 1]
...
def brightness(x, severity=1):
    c = [.1, .2, .3, .4, .5, .6, .7, .8, .9, 1.0][severity - 1]
...
def saturate(x, severity=1):
    c = [(0.3, 0), (0.1, 0), (2, 0), (5, 0.1), (20, 0.2), (20, 0.3), (25, 0.4), (30, 0.5), (35, 0.6), (40, 0.7)][severity - 1]
...
def jpeg_compression(x, severity=1):
    c = [25, 18, 15, 10, 7, 6, 5, 4, 3, 2][severity - 1]
...
def pixelate(x, severity=1):
    c = [0.6, 0.5, 0.4, 0.3, 0.25, 0.2, 0.15, 0.1, 0.05, 0.025][severity - 1]
...
def elastic_transform(image, severity=1):
    c = [(244 * 2, 244 * 0.7, 244 * 0.1),   # 244 should have been 224, but ultimately nothing is incorrect
         ...
         (244 * 4, 244 * 0.8, 244 * 0.3),   # 244 should have been 224, but ultimately nothing is incorrect
         (244 * 3, 244 * 0.08, 244 * 0.4),
         (244 * 0.01, 244 * 0.005, 244 * 0.01),
         (244 * 0.02, 244 * 0.005, 244 * 0.01),
         (244 * 0.4, 244 * 0.005, 244 * 0.01)][severity - 1]
