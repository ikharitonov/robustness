...
test_data = dset.CIFAR10('C:\\Users\\sarfi\\Desktop\\data\\cifar\\train', train=False)
...
for method_name in d.keys():
    ...
    # np.save('C:\\Users\\sarfi\\Desktop\\' + d[method_name].__name__ + '.npy',
    #         np.array(cifar_c).astype(np.uint8))
    np.save('C:\\Users\\sarfi\\Desktop\\' + method_name + '.npy',
            np.array(cifar_c).astype(np.uint8))

    # np.save('C:\\Users\\sarfi\\Desktop\\labels.npy',
